# Workshop: OpenAI writing assistant

<img src="./assets/buildspace-logo.png" alt="Background image">

Very simple OpenAI API app (and Chrome extension) built using React and JavaScript as a workshop from <a href="https://buildspace.so/" alt="Buildspace">Buildspace</a>.
